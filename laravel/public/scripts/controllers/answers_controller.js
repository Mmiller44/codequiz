...
angular.module('codequizApp')
  .controller('answers_controller', ['$scope','$resource','$rootScope','$routeParams','$cookieStore','$window',function($scope, $resource, $rootScope, $routeParams,$cookieStore,$window) {
