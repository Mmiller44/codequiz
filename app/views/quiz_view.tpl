              ...
              <ul>
                  <li class="answer_block">
                    <span class="answer_a"><span class="character">A</span></span>
                      <a href="score.html" class="odd">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugiat fuga nostrum veritatis eos nobis obcaecati nemo soluta quibusdam earum hic in maxime doloribus excepturi quaerat eligendi facilis voluptatem rerum laudantium! </a>
                  </li>
